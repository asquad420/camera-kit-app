...
const entries$1 = (o) => Object.entries(o);
...
class PartialContainer {
  ...
  getFactories(parent) {
    ...
    return factories = Object.fromEntries(entries$1(this.injectables).map(([token, fn]) => [
      token,
      memoize$1(parent, () => fn(...fn.dependencies.map((t2) => {
  ...
  constructor(factories) {
    ...
    for (const k2 in factories) {
      ...
      if (isMemoized(fn)) {
        ...
        memoizedFactories[k2] = memoize$1(this, fn);
      }
    }
...
const fromEntries$1 = (entries2) => Object.fromEntries(entries2);
...
function getLogger(module) {
  return entries(logLevelMap).reduce((logger2, [level]) => {
    logger2[level] = (...messages) => {
...
function mapLogger(logger2) {
  if (!logger2 || logger2 === "noop") {
    return noopLogger;
  }
  if (logger2 === "console") {
    return console;
...
const createArrayBufferParsingHandler = () => (next) => (req, metadata) => __awaiter(void 0, void 0, void 0, function* () {
...
const logger$s = getLogger("retryingHandler");
const logRetry$1 = (responseOrError, sleep2) => {
  logger$s.warn(`Retrying handler got failed response:`, responseOrError, `Waited ${sleep2} millis, attempting retry now.`);
};
const sleep$1 = (millis) => new Promise((resolve) => setTimeout(resolve, millis));
...
const logger$r = getLogger("noCorsRetryingFetchHandler");
const logRetry = (error) => {
  logger$r.warn(`NoCorsRetrying handler got failed response:`, error, `Retrying request with {mode: "no-cors"}.`);
};
...
(function(CameraKitFlavor2) {
  CameraKitFlavor2[CameraKitFlavor2["CAMERA_KIT_FLAVOR_UNSET"] = 0] = "CAMERA_KIT_FLAVOR_UNSET";
  CameraKitFlavor2[CameraKitFlavor2["CAMERA_KIT_FLAVOR_DEBUG"] = 1] = "CAMERA_KIT_FLAVOR_DEBUG";
  CameraKitFlavor2[CameraKitFlavor2["CAMERA_KIT_FLAVOR_RELEASE"] = 2] = "CAMERA_KIT_FLAVOR_RELEASE";
  CameraKitFlavor2[CameraKitFlavor2["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(CameraKitFlavor$1 || (CameraKitFlavor$1 = {}));
var CameraKitConnectivityType$1;
(function(CameraKitConnectivityType2) {
  CameraKitConnectivityType2[CameraKitConnectivityType2["CAMERA_KIT_CONNECTIVITY_TYPE_UNSET"] = 0] = "CAMERA_KIT_CONNECTIVITY_TYPE_UNSET";
  CameraKitConnectivityType2[CameraKitConnectivityType2["CAMERA_KIT_CONNECTIVITY_TYPE_WIFI"] = 1] = "CAMERA_KIT_CONNECTIVITY_TYPE_WIFI";
  CameraKitConnectivityType2[CameraKitConnectivityType2["CAMERA_KIT_CONNECTIVITY_TYPE_MOBILE"] = 2] = "CAMERA_KIT_CONNECTIVITY_TYPE_MOBILE";
  CameraKitConnectivityType2[CameraKitConnectivityType2["CAMERA_KIT_CONNECTIVITY_TYPE_UNREACHABLE"] = 3] = "CAMERA_KIT_CONNECTIVITY_TYPE_UNREACHABLE";
  CameraKitConnectivityType2[CameraKitConnectivityType2["CAMERA_KIT_CONNECTIVITY_TYPE_BLUETOOTH"] = 4] = "CAMERA_KIT_CONNECTIVITY_TYPE_BLUETOOTH";
  CameraKitConnectivityType2[CameraKitConnectivityType2["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(CameraKitConnectivityType$1 || (CameraKitConnectivityType$1 = {}));
var CameraKitEnvironment$1;
(function(CameraKitEnvironment2) {
  CameraKitEnvironment2[CameraKitEnvironment2["CAMERA_KIT_ENVIRONMENT_UNSET"] = 0] = "CAMERA_KIT_ENVIRONMENT_UNSET";
  CameraKitEnvironment2[CameraKitEnvironment2["CAMERA_KIT_ENVIRONMENT_STAGING"] = 1] = "CAMERA_KIT_ENVIRONMENT_STAGING";
  CameraKitEnvironment2[CameraKitEnvironment2["CAMERA_KIT_ENVIRONMENT_PRODUCTION"] = 2] = "CAMERA_KIT_ENVIRONMENT_PRODUCTION";
  CameraKitEnvironment2[CameraKitEnvironment2["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
...
const LegalDocument = {
  encode(message, writer = new BinaryWriter()) {
    ...
    if (message.timestamp !== void 0) {
      Timestamp.encode(toTimestamp$4(message.timestamp), writer.uint32(34).fork()).join();
    }
    return writer;
  },
  decode(input, length) {
...
const OperationalMetric = {
  encode(message, writer = new BinaryWriter()) {
    ...
    if (message.timestamp !== void 0) {
      Timestamp.encode(toTimestamp$3(message.timestamp), writer.uint32(18).fork()).join();
    }
...
(function(module, exports$1) {
  !function(e2, t2) {
    ...
    return e2 = { 418: function(e3, t3) {
      !function(e4, t4) {
        for (var r in t4) e4[r] = t4[r];
      }(t3, function(e4) {
        var t4 = {};
        function r(n2) {
          if (t4[n2]) return t4[n2].exports;
          var o = t4[n2] = { i: n2, l: false, exports: {} };
          return e4[n2].call(o.exports, o, o.exports, r), o.l = true, o.exports;
        }
        return r.m = e4, r.c = t4, r.i = function(e5) {
          return e5;
        }, r.d = function(e5, t5, n2) {
          r.o(e5, t5) || Object.defineProperty(e5, t5, { configurable: false, enumerable: true, get: n2 });
        }, r.n = function(e5) {
          ...
          return r.d(t5, "a", t5), t5;
        }, r.o = function(e5, t5) {
          return Object.prototype.hasOwnProperty.call(e5, t5);
        }, r.p = "", r(r.s = 1);
      }([function(e4, t4, r) {
        Object.defineProperty(t4, "__esModule", { value: true });
        var n2 = r(3), o = function() {
          function e5(e6, t5) {
            void 0 === e6 && (e6 = {}), void 0 === t5 && (t5 = { splitValues: false });
            var r2, o2 = this;
            this.headersMap = {}, e6 && ("undefined" != typeof Headers && e6 instanceof Headers ? n2.getHeaderKeys(e6).forEach(function(r3) {
              n2.getHeaderValues(e6, r3).forEach(function(e7) {
                t5.splitValues ? o2.append(r3, n2.splitHeaderValue(e7)) : o2.append(r3, e7);
              });
            }) : "object" == typeof (r2 = e6) && "object" == typeof r2.headersMap && "function" == typeof r2.forEach ? e6.forEach(function(e7, t6) {
              o2.append(e7, t6);
          ...
          return e5.prototype.appendFromString = function(e6) {
            for (var t5 = e6.split("\r\n"), r2 = 0; r2 < t5.length; r2++) {
              var n3 = t5[r2], o2 = n3.indexOf(":");
              if (o2 > 0) {
            ...
            var r2 = n2.normalizeName(e6);
            if (void 0 === t5) delete this.headersMap[r2];
            else {
              var o2 = this.headersMap[r2];
              if (o2) {
                var s2 = o2.indexOf(t5);
                s2 >= 0 && o2.splice(s2, 1), 0 === o2.length && delete this.headersMap[r2];
              }
            }
          }, e5.prototype.append = function(e6, t5) {
            var r2 = this, o2 = n2.normalizeName(e6);
            Array.isArray(this.headersMap[o2]) || (this.headersMap[o2] = []), Array.isArray(t5) ? t5.forEach(function(e7) {
              r2.headersMap[o2].push(n2.normalizeValue(e7));
            ...
            } else this.headersMap[r2] = [n2.normalizeValue(t5)];
          }, e5.prototype.has = function(e6, t5) {
            var r2 = this.headersMap[n2.normalizeName(e6)];
            ...
            Object.getOwnPropertyNames(this.headersMap).forEach(function(r2) {
              e6(r2, t5.headersMap[r2]);
            }, this);
          }, e5.prototype.toHeaders = function() {
            if ("undefined" != typeof Headers) {
              var e6 = new Headers();
              return this.forEach(function(t5, r2) {
        ...
        Object.defineProperty(t4, "__esModule", { value: true }), t4.iterateHeaders = function(e5, t5) {
          for (var r2 = e5[Symbol.iterator](), n2 = r2.next(); !n2.done; ) t5(n2.value[0]), n2 = r2.next();
        }, t4.iterateHeadersKeys = function(e5, t5) {
          for (var r2 = e5.keys(), n2 = r2.next(); !n2.done; ) t5(n2.value), n2 = r2.next();
        };
      }, function(e4, t4, r) {
        Object.defineProperty(t4, "__esModule", { value: true });
        var n2 = r(2);
        t4.normalizeName = function(e5) {
          ...
          var r2 = e5;
          if (r2 instanceof Headers && r2.getAll) return r2.getAll(t5);
          var n3 = r2.get(t5);
      ...
      function d2(e4, t4, r2) {
        return e4.byteLength - t4 >= r2;
      }
      function c2(e4, t4, r2) {
        if (e4.slice) return e4.slice(t4, r2);
        var n3 = e4.length;
        void 0 !== r2 && (n3 = r2);
      ...
      t3.decodeASCII = i, t3.encodeASCII = function(e4) {
        for (var t4 = new Uint8Array(e4.length), r2 = 0; r2 !== e4.length; ++r2) {
          var n3 = e4.charCodeAt(r2);
      ...
      var p2 = function() {
        ...
        return e4.prototype.parse = function(e5, t4) {
          ...
          if (null == this.buffer) this.buffer = e5, this.position = 0;
            ...
            var p3 = this.buffer.byteLength - this.position, h2 = new Uint8Array(p3 + e5.byteLength), f2 = c2(this.buffer, this.position);
            h2.set(f2, 0);
          ...
          for (; ; ) {
            ...
            if (this.position += 5 + y2, a(b2)) return s3.push({ chunkType: n2.TRAILERS, trailers: (r2 = v2, new o.Metadata(i(r2))) }), s3;
      ...
      }(r = t3.Code || (t3.Code = {})), t3.httpStatusToCode = function(e4) {
        switch (e4) {
          case 0:
            return r.Internal;
          case 200:
    ...
    }, 934: function(e3, t3, r) {
      Object.defineProperty(t3, "__esModule", { value: true }), t3.client = void 0;
      var n2 = r(65), o = r(617), s2 = r(8), i = r(346), a = r(57), u2 = r(882);
      ...
      var d2 = function() {
        ...
        return e4.prototype.createTransport = function() {
          ...
          if (this.props.debug && i.debug("onHeaders", e5, t4), this.closed) this.props.debug && i.debug("grpc.onHeaders received after request was closed - ignoring");
            ...
            var n3 = r2 && r2 >= 0 ? r2 : s2.httpStatusToCode(t4);
          ...
          if (this.closed) this.props.debug && i.debug("grpc.onChunk received after request was closed - ignoring");
            ...
            r2.forEach(function(e6) {
              if (e6.chunkType === o.ChunkType.MESSAGE) {
                var r3 = t4.methodDefinition.responseType.deserializeBinary(e6.data);
                t4.rawOnMessage(r3);
          ...
          if (this.props.debug && i.debug("grpc.onEnd"), this.closed) this.props.debug && i.debug("grpc.onEnd received after request was closed - ignoring");
            ...
            if (null !== e5) {
              var t4 = this.responseTrailers.get("grpc-message"), r2 = this.decodeGRPCStatus(t4[0]);
        ...
        }, e4.prototype.rawOnEnd = function(e5, t4, r2) {
          var n3 = this;
          this.props.debug && i.debug("rawOnEnd", e5, t4, r2), this.completed || (this.completed = true, this.onEndCallbacks.forEach(function(o2) {
            if (!n3.closed) try {
              o2(e5, t4, r2);
            } catch (e6) {
              setTimeout(function() {
        ...
        }, e4.prototype.rawOnError = function(e5, t4, r2) {
          var o2 = this;
          void 0 === r2 && (r2 = new n2.Metadata()), this.props.debug && i.debug("rawOnError", e5, t4), this.completed || (this.completed = true, this.onEndCallbacks.forEach(function(n3) {
            if (!o2.closed) try {
              n3(e5, t4, r2);
            } catch (e6) {
              setTimeout(function() {
      ...
      var n2, o = r(418), s2 = r(57), i = r(229), a = r(540), u2 = r(210), d2 = r(859), c2 = r(8), p2 = r(938), h2 = r(35), f2 = r(934);
      (n2 = t3.grpc || (t3.grpc = {})).setDefaultTransport = s2.setDefaultTransportFactory, n2.CrossBrowserHttpTransport = d2.CrossBrowserHttpTransport, n2.FetchReadableStreamTransport = i.FetchReadableStreamTransport, n2.XhrTransport = u2.XhrTransport, n2.WebsocketTransport = a.WebsocketTransport, n2.Code = c2.Code, n2.Metadata = o.BrowserHeaders, n2.client = function(e4, t4) {
        return f2.client(e4, t4);
      }, n2.invoke = p2.invoke, n2.unary = h2.unary;
    }, 938: function(e3, t3, r) {
      ...
      t3.invoke = function(e4, t4) {
        ...
        var r2 = n2.client(e4, { host: t4.host, transport: t4.transport, debug: t4.debug });
        return t4.onHeaders && r2.onHeaders(t4.onHeaders), t4.onMessage && r2.onMessage(t4.onMessage), t4.onEnd && r2.onEnd(t4.onEnd), r2.start(t4.metadata), r2.send(t4.request), r2.finishSend(), { close: function() {
          r2.close();
        } };
      };
    }, 65: function(e3, t3, r) {
    ...
    }, 229: function(e3, t3, r) {
      var n2 = this && this.__assign || function() {
        return (n2 = Object.assign || function(e4) {
          for (var t4, r2 = 1, n3 = arguments.length; r2 < n3; r2++) for (var o2 in t4 = arguments[r2]) Object.prototype.hasOwnProperty.call(t4, o2) && (e4[o2] = t4[o2]);
          return e4;
      ...
      var i = function() {
        ...
        return e4.prototype.pump = function(e5, t4) {
          ...
          if (this.reader = e5, this.cancelled) return this.options.debug && s2.debug("Fetch.pump.cancel at first pump"), void this.reader.cancel().catch(function(e6) {
            r2.options.debug && s2.debug("Fetch.pump.reader.cancel exception", e6);
          });
          this.reader.read().then(function(e6) {
            if (e6.done) return r2.options.onEnd(), t4;
            r2.options.onChunk(e6.value), r2.pump(r2.reader, t4);
          }).catch(function(e6) {
            r2.cancelled ? r2.options.debug && s2.debug("Fetch.catch - request cancelled") : (r2.cancelled = true, r2.options.debug && s2.debug("Fetch.catch", e6.message), r2.options.onEnd(e6));
          });
        }, e4.prototype.send = function(e5) {
          var t4 = this;
    ...
    }, 210: function(e3, t3, r) {
      var n2, o = this && this.__extends || (n2 = function(e4, t4) {
        return (n2 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e5, t5) {
          e5.__proto__ = t5;
        } || function(e5, t5) {
          for (var r2 in t5) Object.prototype.hasOwnProperty.call(t5, r2) && (e5[r2] = t5[r2]);
        })(e4, t4);
      }, function(e4, t4) {
        function r2() {
          this.constructor = e4;
        }
        n2(e4, t4), e4.prototype = null === t4 ? Object.create(t4) : (r2.prototype = t4.prototype, new r2());
      });
      ...
      var s2 = r(65), i = r(346), a = r(849);
      t3.XhrTransport = function(e4) {
        return function(t4) {
          if (a.detectMozXHRSupport()) return new d2(t4, e4);
          if (a.detectXHROverrideMimeTypeSupport()) return new u2(t4, e4);
      ...
      var u2 = function() {
        ...
        return e4.prototype.onProgressEvent = function() {
          ...
          this.xhr = r2, r2.open("POST", this.options.url), this.configureXhr(), this.metadata.forEach(function(e6, t5) {
            r2.setRequestHeader(e6, t5.join(", "));
      ...
      function c2(e4, t4) {
        var r2 = e4.charCodeAt(t4);
        if (r2 >= 55296 && r2 <= 56319) {
          var n3 = e4.charCodeAt(t4 + 1);
          n3 >= 56320 && n3 <= 57343 && (r2 = 65536 + (r2 - 55296 << 10) + (n3 - 56320));
        }
        return r2;
      }
      function p2(e4) {
        for (var t4 = new Uint8Array(e4.length), r2 = 0, n3 = 0; n3 < e4.length; n3++) {
          ...
          return function(e5) {
            ...
            function u2(e6) {
              if (e6 === n2.FINISH_SEND) t4.send(i);
                ...
                o2.set(new Uint8Array([0])), o2.set(r3, 1), t4.send(o2);
              }
            }
            return { sendMessage: function(e6) {
              ...
              (t4 = new WebSocket(r2, ["grpc-websockets"])).binaryType = "arraybuffer", t4.onopen = function() {
                var r3;
                e5.debug && o.debug("websocketRequest.onopen"), t4.send((r3 = "", n3.forEach(function(e6, t5) {
                  r3 += e6 + ": " + t5.join(", ") + "\r\n";
                }), s2.encodeASCII(r3))), a.forEach(function(e6) {
                  u2(e6);
                });
      ...
      t3.unary = function(e4, t4) {
        ...
        var r2 = null, s2 = null, i = o.client(e4, { host: t4.host, transport: t4.transport, debug: t4.debug });
        return i.onHeaders(function(e5) {
          r2 = e5;
        }), i.onMessage(function(e5) {
          s2 = e5;
        }), i.onEnd(function(e5, o2, i2) {
          t4.onEnd({ status: e5, statusMessage: o2, headers: r2 || new n2.Metadata(), message: s2, trailers: i2 });
      ...
      Object.defineProperty(t3, "__esModule", { value: true }), t3.frameRequest = void 0, t3.frameRequest = function(e4) {
        var t4 = e4.serializeBinary(), r = new ArrayBuffer(t4.byteLength + 5);
        return new DataView(r, 1, 4).setUint32(0, t4.length, false), new Uint8Array(r, 5).set(t4), new Uint8Array(r);
      };
    } }, t2 = {}, function r(n2) {
      if (t2[n2]) return t2[n2].exports;
      var o = t2[n2] = { exports: {} };
      return e2[n2].call(o.exports, o, o.exports, r), o.exports;
    }(607);
    var e2, t2;
  });
})(grpcWebClient_umd);
...
class OkResult {
  ...
  map(m2) {
    return new OkResult(m2(this.value));
  }
  flatMap(m2) {
...
const environment = { PACKAGE_VERSION: "1.13.0" };
const lensCoreWasm = {
  version: "340",
  buildNumber: "c72c304",
...
const getPlatformInfo = memoize(function getPlatformInfo2() {
  var _a, _b, _c;
...
const getCameraKitUserAgent = memoize(function getCameraKitUserAgent2() {
  var _a;
...
const createRequestStateEmittingHandler = (requestStateEventTarget) => (next) => ([request, dimensions], metadata) => __awaiter(void 0, void 0, void 0, function* () {
  ...
  try {
    ...
    dispatchRequestCompleted(requestStateEventTarget, { requestId: requestId2, dimensions, status: status2, sizeByte });
    return response;
  } catch (error) {
...
const grpcHandlerFactory = Injectable("grpcHandlerFactory", [configurationToken, cameraKitServiceFetchHandlerFactory.token, requestStateEventTargetFactory.token], (configuration, fetchHandler, requestStateEventTarget) => {
    ...
    return {
      sendMessage(msgBytes) {
        ...
        request.then((response) => {
          options.onHeaders(new grpcWebClient_umdExports.grpc.Metadata(response.headers), response.status);
  ...
  return (request) => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((resolve) => {
      grpcWebClient_umdExports.grpc.unary({
...
function isUnaryOutputOk(value) {
  return value.status === grpcWebClient_umdExports.grpc.Code.OK;
}
      ...
      function(modules) {
        ...
        function(module2, exports$12, __webpack_require__) {
          ...
          var BrowserHeaders = function() {
            function BrowserHeaders2(init, options) {
              if (init === void 0) {
                init = {};
              }
              if (options === void 0) {
          ...
          exports$12.BrowserHeaders = BrowserHeaders;
        },
        /* 1 */
        /***/
        function(module2, exports$12, __webpack_require__) {
          ...
          exports$12.BrowserHeaders = BrowserHeaders_1.BrowserHeaders;
        },
        /* 2 */
        /***/
        function(module2, exports$12, __webpack_require__) {
          ...
          exports$12.iterateHeaders = iterateHeaders;
          ...
          exports$12.iterateHeadersKeys = iterateHeadersKeys;
        },
        /* 3 */
        /***/
        function(module2, exports$12, __webpack_require__) {
          ...
          exports$12.normalizeName = normalizeName;
          ...
          exports$12.normalizeValue = normalizeValue;
          ...
          exports$12.getHeaderValues = getHeaderValues;
          ...
          exports$12.getHeaderKeys = getHeaderKeys;
          ...
          exports$12.splitHeaderValue = splitHeaderValue;
        }
        /******/
      ])
    );
...
function unionBy(iteratee, ...arrays) {
  ...
  for (const item of arrays.flat()) {
    const key = typeof item === "object" && item !== null && iteratee in item ? item[iteratee] : throwIterateeError();
    seen.set(key, item);
  }
...
const BenchmarkRequest = {
  encode(message, writer = new BinaryWriter()) {
    ...
    if (message.expirationTimestamp !== void 0) {
      Timestamp.encode(toTimestamp$2(message.expirationTimestamp), writer.uint32(18).fork()).join();
    }
    return writer;
  },
  decode(input, length) {
  ...
  unary(methodDesc, _request, metadata) {
    ...
    return new Promise((resolve, reject) => {
      ...
      grpcWebClient_umdExports.grpc.unary(methodDesc, Object.assign(Object.assign({ request, host: this.host, metadata: maybeCombinedMetadata !== null && maybeCombinedMetadata !== void 0 ? maybeCombinedMetadata : {} }, this.options.transport !== void 0 ? { transport: this.options.transport } : {}), { debug: (_a2 = this.options.debug) !== null && _a2 !== void 0 ? _a2 : false, onEnd: function(response) {
        if (response.status === grpcWebClient_umdExports.grpc.Code.OK) {
...
const logger$q = getLogger("responseCachingHandler");
...
const staleWhileRevalidateStrategy = (options) => (key, cache, network) => __awaiter(void 0, void 0, void 0, function* () {
  var _c, _d;
  try {
    ...
    network({ isSideEffect: true }).then((response) => cache.store(key, response)).catch((error) => {
      logger$q.warn(`staleWhileRevalidateStrategy failed to retrieve and store key ${key}.`, error);
    });
    ...
    try {
      ...
      cache.store(key, response).catch((error) => {
        logger$q.warn(`staleWhileRevalidateStrategy failed to store key ${key}.`, error);
      });
      logger$q.debug(`staleWhileRevalidateStrategy successfully fell back to network for key ${key} after cache error.`, cacheError);
      return response;
    } catch (networkError) {
...
const createResponseCachingHandler = (cache, resolveKey, strategy) => {
  return (next) => (request, metadata) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      logger$q.warn("Cache lookup failed because the cache key could not be resolved.", error);
      return network();
    }
...
const logger$p = getLogger("ExpiringPersistence");
class ExpiringPersistence {
  constructor(expiration, persistence) {
    this.expiration = expiration;
    this.persistence = persistence;
    this.removeExpired().catch((error) => {
      logger$p.warn("Failed to cleanup expired entries on startup.", error);
    });
  }
  get size() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (Date.now() > expiry) {
        yield this.persistence.remove(key).catch((error) => {
          logger$p.warn(`Key ${key} is expired, but removing it from persistence failed.`, error);
        });
        return void 0;
      }
      return value;
  ...
  removeExpired() {
    return __awaiter(this, void 0, void 0, function* () {
      for (const [key, [expiry]] of yield this.persistence.retrieveAll()) {
        if (Date.now() >= expiry) {
          yield this.persistence.remove(key).catch((error) => logger$p.warn(`Failed to remove expired key ${key}.`, error));
        }
      }
    });
  }
...
class PageVisibility {
  ...
  onVisibilityChange() {
    const handlers2 = this.previousVisibilityState === "visible" && document.visibilityState === "hidden" ? this.onHiddenHandlers : this.previousVisibilityState === "hidden" && document.visibilityState === "visible" ? this.onVisibleHandlers : /* @__PURE__ */ new Set();
...
const ServerEventData = {
  encode(message, writer = new BinaryWriter()) {
    ...
    if (message.cameraKitSession !== void 0) {
      CameraKitSession$1.encode(message.cameraKitSession, writer.uint32(2130).fork()).join();
    }
...
(function(CameraKitEnvironment2) {
  CameraKitEnvironment2[CameraKitEnvironment2["CAMERA_KIT_ENVIRONMENT_UNKNOWN"] = 0] = "CAMERA_KIT_ENVIRONMENT_UNKNOWN";
  CameraKitEnvironment2[CameraKitEnvironment2["CAMERA_KIT_ENVIRONMENT_STAGING"] = 1] = "CAMERA_KIT_ENVIRONMENT_STAGING";
  CameraKitEnvironment2[CameraKitEnvironment2["CAMERA_KIT_ENVIRONMENT_PRODUCTION"] = 2] = "CAMERA_KIT_ENVIRONMENT_PRODUCTION";
  CameraKitEnvironment2[CameraKitEnvironment2["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
...
(function(CameraKitConnectivityType2) {
  CameraKitConnectivityType2[CameraKitConnectivityType2["CAMERA_KIT_CONNECTIVITY_TYPE_UNKNOWN"] = 0] = "CAMERA_KIT_CONNECTIVITY_TYPE_UNKNOWN";
  CameraKitConnectivityType2[CameraKitConnectivityType2["CAMERA_KIT_CONNECTIVITY_TYPE_WIFI"] = 1] = "CAMERA_KIT_CONNECTIVITY_TYPE_WIFI";
  CameraKitConnectivityType2[CameraKitConnectivityType2["CAMERA_KIT_CONNECTIVITY_TYPE_MOBILE"] = 2] = "CAMERA_KIT_CONNECTIVITY_TYPE_MOBILE";
  CameraKitConnectivityType2[CameraKitConnectivityType2["CAMERA_KIT_CONNECTIVITY_TYPE_UNREACHABLE"] = 3] = "CAMERA_KIT_CONNECTIVITY_TYPE_UNREACHABLE";
  CameraKitConnectivityType2[CameraKitConnectivityType2["CAMERA_KIT_CONNECTIVITY_TYPE_BLUETOOTH"] = 4] = "CAMERA_KIT_CONNECTIVITY_TYPE_BLUETOOTH";
...
var CameraKitFlavor;
(function(CameraKitFlavor2) {
  CameraKitFlavor2[CameraKitFlavor2["CAMERA_KIT_FLAVOR_UNKNOWN"] = 0] = "CAMERA_KIT_FLAVOR_UNKNOWN";
  CameraKitFlavor2[CameraKitFlavor2["CAMERA_KIT_FLAVOR_DEBUG"] = 1] = "CAMERA_KIT_FLAVOR_DEBUG";
  CameraKitFlavor2[CameraKitFlavor2["CAMERA_KIT_FLAVOR_RELEASE"] = 2] = "CAMERA_KIT_FLAVOR_RELEASE";
  CameraKitFlavor2[CameraKitFlavor2["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
...
const createMappingHandler = (map2, pageVisibility, maxMapConcurrency = Number.POSITIVE_INFINITY) => {
  const buffer2 = [];
...
const METRIC_REQUEST_RATE_LIMIT_MS = 1e3;
const BUSINESS_EVENT_BATCH_MAX_SIZE = 10;
const BUSINESS_EVENT_BATCH_MAX_AGE_MS = 5e3;
const METRIC_BATCH_MAX_SIZE = 100;
const METRIC_BATCH_MAX_AGE_MS = 5e3;
class MetricsClient {
...
const metricsClientFactory = Injectable("metricsClient", [externalMetricsSubjectFactory.token, grpcHandlerFactory.token, pageVisibilityFactory.token], (externalMetricsSubjectFactory2, grpcHandler, pageVisibility) => {
...
const logger$o = getLogger("cofHandler");
const cofHandlerFactory = Injectable("cofHandler", [configurationToken, requestStateEventTargetFactory.token, metricsClientFactory.token], (config2, requestStateEventTarget, metrics) => {
  const cofCache = new ExpiringPersistence(() => convertDaysToSeconds(365), new IndexedDBPersistence({ databaseName: "COFCache" }));
  const getCacheKey2 = (r) => JSON.stringify(r);
  return new HandlerChainBuilder((request, _a) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
      ...
      const cachedResponse = yield cofCache.retrieve(getCacheKey2(request)).catch((e2) => {
        logger$o.warn("Unable to get COF response from cache.", e2);
        return {
  ...
  })).map(createRetryingHandler({ retryPredicate: (r) => r instanceof Error })).map(createTimeoutHandler({ timeout: 20 * 1e3 })).map(createResponseCachingHandler(cofCache, getCacheKey2, staleWhileRevalidateStrategy({
    onMiss: () => {
...
const remoteConfigurationFactory = Injectable("remoteConfiguration", [configurationToken, cofHandlerFactory.token, grpcHandlerFactory.token], (config2, cofHandler, grpcHandler) => {
...
const logger$n = getLogger("deviceDependentAssetLoader");
  ...
  return function deviceDependentAssetLoader({ assetDescriptor: { assetId }, lowPriority }) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return firstValueFrom(remoteConfiguration.get(assetId).pipe(catchError((error) => {
        ...
        logger$n.info(`COF request for ${assetId}. url: ${assetConfig.url}. checksum: ${assetConfig.checksum}.`);
        return assetConfig;
...
const relaxedSimd = async () => WebAssembly.validate(new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 5, 1, 96, 0, 1, 123, 3, 2, 1, 0, 10, 15, 1, 13, 0, 65, 1, 253, 15, 65, 2, 253, 15, 253, 128, 2, 11])), simd = async () => WebAssembly.validate(new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 5, 1, 96, 0, 1, 123, 3, 2, 1, 0, 10, 10, 1, 8, 0, 65, 0, 253, 15, 253, 98, 11]));
...
function getWebAssemblyCapabilities() {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const [simd$1, relaxedSimd$1] = yield Promise.all([
      simd().then((simd2) => {
...
const getPlatformCapabilities = memoize(function getPlatformCapabilities2() {
  return __awaiter(this, void 0, void 0, function* () {
    return {
...
function getBuildFlavor({ simd: simd2, relaxedSimd: relaxedSimd2 }, versionNumber) {
...
const logger$m = getLogger("lensCoreFactory");
const findMatch = (regex, strings) => strings.find((s2) => regex.test(s2));
const LENS_CORE_JS_REQUEST_TYPE = "lens_core_js";
const LENS_CORE_WASM_REQUEST_TYPE = "lens_core_wasm";
const lensCoreFactory = Injectable("lensCore", [defaultFetchHandlerFactory.token, configurationToken, requestStateEventTargetFactory.token], (handler, { lensCoreOverrideUrls, wasmEndpointOverride, trustedTypesPolicyName }, requestStateEventTarget) => __awaiter(void 0, void 0, void 0, function* () {
  var _a, _b;
  let lensCoreJS;
  let lensCoreWASM;
  ...
  if (lensCoreWasm.version != `${lensCore.getCoreVersion()}`) {
    logger$m.warn(`Loaded LensCore version (${lensCore.getCoreVersion()}) differs from expected one (${lensCoreWasm.version})`);
  }
...
function errorLoggingDecorator(logger2) {
  const handleError = (error) => logger2.error(error);
...
const logger$l = getLogger("LensAssetRepository");
      ...
      try {
        ...
        this.lensCore.provideRemoteAssetsResponse({
          ...
          onFailure: (lensCoreError) => {
            ...
            logger$l.warn(`Failed to provide lens asset ${assetId}.`, lensCoreError);
          }
        });
      } catch (error) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      yield Promise.all(assetDescriptors.filter((assetDescriptors2) => !this.cachedAssetKeys.has(getCacheKey(assetDescriptors2))).map((assetDescriptor) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
          ...
          logger$l.warn(`Failed to cache asset ${assetId} of type ${assetTypeName !== null && assetTypeName !== void 0 ? assetTypeName : assetType.value}.`, error);
        }
      })));
    });
  }
...
const logger$k = getLogger("LensRepository");
...
let LensRepository = (() => {
  ...
  return _a = class LensRepository {
      ...
      return __awaiter(this, void 0, void 0, function* () {
        const responses = yield Promise.all(groupIds.map((groupId) => __awaiter(this, void 0, void 0, function* () {
          try {
            ...
            logger$k.error(new Error(`Failed to load lens group ${groupId}.`, { cause: error }));
            return error;
          }
        })));
      ...
      return __awaiter(this, void 0, void 0, function* () {
        ...
        yield Promise.all(lenses.map((lens) => __awaiter(this, void 0, void 0, function* () {
          try {
            ...
            logger$k.warn(`Failed to cache lens ${lens.id}.`, error);
          }
        })));
      });
    }
    ...
    _loadLens_decorators = [validate(isSafeString, isSafeString), errorLoggingDecorator(logger$k)];
    _loadLensGroups_decorators = [validate(isSafeStringArray), errorLoggingDecorator(logger$k)];
    _cacheLensContent_decorators = [validate(isLensArray, isAssetTimingArrayOrUndefined), errorLoggingDecorator(logger$k)];
...
const fromEntries = (entries2) => Object.fromEntries(entries2);
...
class StateMachine {
  ...
  constructor(actions, states, initialState, reducer) {
    ...
    this.actionsSubject.pipe(withLatestFrom(this.state), mergeMap(([a, s2]) => (
      ...
      NEVER.pipe(startWith([a, s2]), reducer, raceWith(of(s2)), tap((newState) => {
        if (newState !== s2)
...
const FriendUserInfo = {
  encode(message, writer = new BinaryWriter()) {
    if (message.friendshipStart !== void 0) {
      Timestamp.encode(toTimestamp$1(message.friendshipStart), writer.uint32(10).fork()).join();
    }
    if (message.lastInteraction !== void 0) {
      Timestamp.encode(toTimestamp$1(message.lastInteraction), writer.uint32(18).fork()).join();
    }
    if (message.streak !== 0) {
...
const defaultOptions$1 = Object.assign(Object.assign({}, defaultDeviceInfo), { transform: Transform2D.Identity, disableSourceAudio: false });
...
const logger$j = getLogger("RenderingMetrics");
let LensPerformanceMetrics = (() => {
  ...
  return _a = class LensPerformanceMetrics {
    ...
    _beginMeasurement_decorators = [errorLoggingDecorator(logger$j)];
...
const logger$i = getLogger("LensPersistenceStore");
const lensPersistenceStoreFactory = Injectable("lensPersistenceStore", [lensCoreFactory.token], (lensCore) => {
  ...
  lensCore.registerSavePersistentStoreCallback((id, data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      logger$i.error(persistentStoreError(`Error occurred while storing data for lens ${id}.`, error));
    }
  }));
  return db;
});
...
const logger$h = getLogger("LegalState");
...
const defaultLegalDocumentDate = /* @__PURE__ */ new Date("2021-09-30T00:00:00+00:00");
...
const legalStateFactory = Injectable("legalState", [remoteConfigurationFactory.token, legalPromptFactory.token], (remoteConfig, legalPrompt) => {
  ...
  const getLastAcceptedTosContentHash = () => from(persistance.retrieve(tosContentHashKey).catch((error) => logger$h.warn(error)));
  const setLastAcceptedTosContentHash = (hash) => persistance.store(tosContentHashKey, hash).catch((error) => logger$h.warn(error));
  ...
  legalState.events.pipe(inStates("unknown"), forActions("requestLegalPrompt"), switchMap(() => forkJoin({
    cofConfig: remoteConfig.get("CAMERA_KIT_LEGAL_PROMPT").pipe(map((configResults) => {
      const config2 = configResults.find(hasAnyValue$1);
      if (!config2)
...
const logger$g = getLogger("fetchWatermarkLens");
...
const lensStateFactory = Injectable("lensState", [
  ...
  lensState.events.pipe(forActions("applyLens"), exhaustMap(([a]) => of(legalState.actions.requestLegalPrompt()).pipe(dispatch(legalState), inStates("accepted", "rejected"), take(1), map(([, { name }]) => {
    ...
    return forkJoin({
      ...
      lensInput: of(a.data).pipe(mergeMap(({ lens: lens2, launchData }) => {
  ...
  lensState.events.pipe(inStates("applyingLens"), forActions("removeLens"), switchMap(([a]) => lensState.events.pipe(inStates("lensApplied"), takeUntil(lensState.events.pipe(forActions("applyLens"))), map(() => a))), dispatch(lensState)).subscribe({
    error: logger$f.error
  });
  lensState.events.subscribe(([a, s2]) => {
    const data = extractLoggableData(a);
    logger$f.debug(`Action: "${a.name}", state: "${s2.name}"${data ? ", data: " + JSON.stringify(data) : ""}`);
  });
  return lensState;
});
...
const logger$e = getLogger("LensKeyboard");
class LensKeyboard {
    ...
    this.uriHandler = {
      ...
      handleRequest: (request, reply) => {
        if (request.uri === "app://textInput/requestKeyboard") {
          ...
          logger$e.error(new Error(`Unhandled lens keyboard request '${request.uri}'.`));
        }
      }
    };
...
const EPS = 1e-6;
const isFiniteNumber = (v2) => typeof v2 === "number" && Number.isFinite(v2);
function isNormalizedRectLike(obj) {
  ...
  if (![x, y2, width, height].every(isFiniteNumber))
    return false;
  if (width < 0 || height < 0)
    return false;
  const x2 = x + width;
...
const logger$c = getLogger("CameraKitSession");
      ...
      this.subscriptions = [
        ...
        logEntries.pipe(filter((entry) => entry.level === "error"), map((entry) => entry.messages.find((e2) => e2 instanceof Error)), filter(isPublicLensError)).subscribe((error) => {
          ...
          if (!isState(state, "noLensApplied")) {
            ...
            logger$c.warn("Lens error occurred even though there is no active lens.", error);
          }
        })
      ];
    }
    ...
    setSource(source, options = {}) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        yield cameraKitSource.attach(this.lensCore, this.frameEvents, (error) => {
          logger$c.error(cameraKitSourceError("Error occurred during source attachment.", error));
        });
    ...
    destroy() {
      return __awaiter(this, void 0, void 0, function* () {
        try {
          ...
          logger$c.warn("An error occurred in LensCore during the session termination process.", error);
        }
        ...
        if (this.source) {
          try {
            yield this.source.detach((error) => {
              logger$c.error(cameraKitSourceError("Error occurred during source detachment.", error));
            });
          } catch (error) {
            logger$c.error(cameraKitSourceError(`Detaching prior source of type ${getTypeName(this.source)} failed.`, error));
          }
        }
      });
    }
  }, (() => {
    _applyLens_decorators = [validate(isLens, isLensLaunchDataOrUndefined), errorLoggingDecorator(logger$c)];
    _removeLens_decorators = [errorLoggingDecorator(logger$c)];
    _play_decorators = [validate(isRenderTargetOrUndefined), errorLoggingDecorator(logger$c)];
    _pause_decorators = [validate(isRenderTargetOrUndefined), errorLoggingDecorator(logger$c)];
    _mute_decorators = [errorLoggingDecorator(logger$c)];
    _unmute_decorators = [errorLoggingDecorator(logger$c)];
    _setSource_decorators = [validate(isAllowedSource, isPartialCameraKitDeviceOptionsOrUndefined), errorLoggingDecorator(logger$c)];
    _setFPSLimit_decorators = [validate(isValidNumber), errorLoggingDecorator(logger$c)];
    _setScreenRegions_decorators = [validate(isScreenRegions), errorLoggingDecorator(logger$c)];
    _destroy_decorators = [errorLoggingDecorator(logger$c)];
...
const logger$b = getLogger("LensAssetProvider");
  ...
  lensCore.setRemoteAssetsProvider((assetDescriptor) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      if (consecutiveErrors <= maxConsecutiveErrors) {
        logger$b.error(lensAssetError(`Error occurred while handling lens asset ${assetId} request.`, error));
      } else {
        logger$b.warn(`Maximum consecutive asset load errors reached for asset ${assetId}`);
      }
    }
  }));
});
...
const logger$a = getLogger("lensHttpHandler");
...
const logger$9 = getLogger("RemoteApiServices");
...
const logger$8 = getLogger("uriHandlersRegister");
...
function reportExceptionToBlizzard(logEntries, metricsEventTarget, metrics, lensState) {
  logEntries.pipe(scan$1(({ entries: entries2 }, newEntry) => {
...
const reportBenchmarks = Injectable("reportBenchmarks", [metricsEventTargetFactory.token, metricsClientFactory.token, configurationToken], (metricsEventTarget, metrics, config2) => __awaiter(void 0, void 0, void 0, function* () {
...
const reportHttpMetrics = Injectable("reportHttpMetrics", [metricsClientFactory.token, requestStateEventTargetFactory.token], (metrics, requestStateEventTarget) => {
  scan({ name: "inProgress", inProgress: /* @__PURE__ */ new Map() })(requestStateEventTarget, ["started", "completed", "errored"], (state, event) => {
    var _a;
...
const reportLensValidationFailed = Injectable("reportLensValidationFailed", [lensStateFactory.token, metricsEventTargetFactory.token], (lensState, metricsEventTarget) => {
  lensState.events.pipe(forActions("applyLensFailed"), filter(([a]) => a.data.error.name === "LensContentValidationError")).subscribe({
    next: ([{ data }]) => {
      const { lens } = data;
...
const viewTimeThresholdSec$1 = 0.1;
...
const reportLensView = Injectable("reportLensView", [
  ...
  metricsClientFactory.token,
  configurationToken
], (session2, lensState, sessionState, metricsEventTarget, metrics, configuration) => __awaiter(void 0, void 0, void 0, function* () {
  var _a;
  ...
  merge(lensState.events.pipe(forActions("downloadComplete"), map(([a]) => a.data)), lensState.events.pipe(inStates("lensApplied"), switchMap(([, s2]) => sessionState.events.pipe(forActions("resume"), takeUntil(lensState.events.pipe(forActions("removeLens"))), map(() => s2.data))))).pipe(map((lens) => [getTimeMs(), lens.id, lens.groupId]), mergeMap(([applyLensStartTime, lensId, lensGroupId]) => {
    ...
    const viewMetrics = (alreadyOn ? of([getTimeMs(), session2.metrics.beginMeasurement()]) : lensState.events.pipe(forActions("turnedOn"), filter(([a]) => a.data.id === lensId), map(() => [getTimeMs(), session2.metrics.beginMeasurement()]))).pipe(take(1), mergeMap(([lensTurnedOnTime, metricsMeasurement]) => lensState.events.pipe(forActions("turnedOff"), filter(([a]) => a.data.id === lensId), raceWith(sessionState.events.pipe(forActions("suspend"))), map(() => {
      metricsMeasurement.end();
      return Object.assign({ viewTimeSec: (getTimeMs() - lensTurnedOnTime) / 1e3 }, metricsMeasurement.measure());
    }))));
    return applyDelay.pipe(combineLatestWith(viewMetrics, from(isFirstTimeWithinPeriods(lensId, lensViewPersistence))), takeUntil(lensState.events.pipe(forActions("turnedOn"), filter(([a]) => a.data.id !== lensId))), take(1), map(([applyDelaySec, viewMetrics2, isFirstTimeResults]) => Object.assign(Object.assign({
      applyDelaySec,
      lensId,
      lensGroupId
    ...
    next: ({ applyDelaySec, lensId, lensGroupId, viewTimeSec, avgFps, lensFrameProcessingTimeMsAvg, lensFrameProcessingTimeMsStd, lensFrameProcessingTimeMsMedian, lensFrameProcessingN, isLensFirstWithinDay, isLensFirstWithinMonth }) => __awaiter(void 0, void 0, void 0, function* () {
      if (viewTimeSec < viewTimeThresholdSec$1)
        return;
      const lensView = {
        name: "lensView",
        applyDelaySec,
...
const reportUserSession = Injectable("reportUserSession", [metricsEventTargetFactory.token], (metricsEventTarget) => __awaiter(void 0, void 0, void 0, function* () {
  var _a, _b;
  ...
  metricsEventTarget.dispatchEvent(new TypedCustomEvent("session", session2));
}));
const reportPlatformCapabilities = Injectable("reportPlatformCapabilities", [metricsClientFactory.token], (metrics) => __awaiter(void 0, void 0, void 0, function* () {
...
const reportGloballyScopedMetrics = new PartialContainer({}).provides(reportHttpMetrics).provides(reportBenchmarks).provides(reportLensAndAssetDownload).provides(reportLegalState).provides(reportPlatformCapabilities);
const reportSessionScopedMetrics = new PartialContainer({}).provides(reportUserSession).provides(reportLensView).provides(reportLensWait).provides(reportSessionException).provides(reportLensValidationFailed);
const e = (() => {
...
const EXIF_ID = 1165519206;
const LITTLE_ENDIAN = 18761;
const ORIENTATION_TAG_OFFSET = 274;
var Orientation;
...
const logger$7 = getLogger("lensClientInterfaceImagePicker");
const mimeTypes = {
  image: [
    "image/avif",
    "image/bmp",
...
function pickClientImage(clientInterfaceData, lensCore, filePicker) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    logger$7.debug(`Opening file dialog for MIME types: ${mimeTypes2}`);
...
const logger$6 = getLogger("lensClientInterface");
...
const logger$5 = getLogger("setPreloadedConfiguration");
...
const logger$4 = getLogger("registerGeoDataProvider");
...
const logger$3 = getLogger("CameraKit");
  ...
  return _a = class CameraKit {
      ...
      return __awaiter(this, void 0, void 0, function* () {
        const exceptionHandler = (error) => {
          if (error.name === "LensCoreAbortError") {
            logger$3.error(lensAbortError("Unrecoverable error occurred during lens execution. The CameraKitSession will be destroyed.", error));
          } else {
            logger$3.error(lensExecutionError("Error occurred during lens execution. The lens cannot be rendered and will be removed from the CameraKitSession.", error));
          }
        };
        const config2 = this.container.get(configurationToken);
        const trustedTypesHandler = getTrustedTypesHandler(config2.trustedTypesPolicyName);
        ...
        if (config2.fonts.length > 0) {
          this.lensCore.setSystemFonts({
            fonts: config2.fonts.map((font) => Object.assign(Object.assign({}, font), { data: font.data.slice(0) }))
          });
        }
        ...
        const sessionContainer = this.container.copy().provides(sessionStateFactory).provides(lensStateFactory).provides(lensKeyboardFactory).provides(frameEventsFactory).provides(cameraKitSessionFactory).run(registerLensAssetsProvider).run(registerLensClientInterfaceHandler).run(registerGeoDataProvider).run(setPreloadedConfiguration).run(reportSessionScopedMetrics).run(registerUriHandlers);
        const session2 = sessionContainer.get(cameraKitSessionFactory.token);
    ...
    destroy() {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        yield Promise.all(this.sessions.map((session2) => session2.destroy()));
        this.sessions = [];
      });
    }
  }, (() => {
...
const logger$2 = getLogger("BusinessEventsReporter");
...
const businessEventsReporterFactory = Injectable("businessEventsReporter", [
  ...
  listenAndReport(metricsEventTarget, metricsClient, {
    ...
    session: (event) => [
      "CAMERA_KIT_SESSION",
      { cameraKitSession: CameraKitSession$1.fromPartial(event) }
    ]
...
const logger$1 = getLogger("CameraKitLensSource");
const hasAnyValue = (c2) => {
  var _a, _b;
  return ((_b = (_a = c2.value) === null || _a === void 0 ? void 0 : _a.anyValue) === null || _b === void 0 ? void 0 : _b.value) instanceof Uint8Array;
};
    ...
    loadLens() {
      return __awaiter(this, void 0, void 0, function* () {
        const lensMessage = yield firstValueFrom(remoteConfig.get("CAMERA_KIT_WATERMARK_LENS").pipe(map((configResults) => {
          var _a;
          const lensMessage2 = (_a = configResults.find(hasAnyValue)) === null || _a === void 0 ? void 0 : _a.value.anyValue.value;
          if (!lensMessage2)
...
function bootstrapCameraKit(configuration, provide) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    try {
      ...
      const cameraKit2 = container.get(cameraKitFactory.token);
...
const getExtensionRequestContext = memoize(function getExtensionRequestContext2() {
...
const API_TOKEN = "eyJhbGciOiJIUzI1NiIsImtpZCI6IkNhbnZhc1MyU0hNQUNQcm9kIiwidHlwIjoiSldUIn0.eyJhdWQiOiJjYW52YXMtY2FudmFzYXBpIiwiaXNzIjoiY2FudmFzLXMyc3Rva2VuIiwibmJmIjoxNzY5NTQzOTkzLCJzdWIiOiI1YTE2MTliYy03ODNjLTQ1NGEtYTlmZS1hOTk2ZTA4NmQ4OWR-UFJPRFVDVElPTn43YWVlYWI0YS0zYTMwLTQzMDgtYjE0ZC04ZDUwMjliYjMyNWQifQ.Ymf-Dfjk8UNCcpG8A8wwqzvYnDRJlOqRcu7c_XmCfjU";
const GROUP_ID = "497ceed3-510c-4691-8608-fc889e381ae5";
let lensConfig = JSON.parse(localStorage.getItem("lensConfig")) || [
  { id: "81852eba-0b89-4027-90c1-2c75c71462b5", name: "Ethereal Squid" }
];
let cameraKit, session, currentLens, mediaStream;
let videoDevices = [];
...
const lensListDiv = document.getElementById("lensList");
const addLensBtn = document.getElementById("addLensBtn");
(async function() {
  try {
    status.textContent = "Initializing Camera Kit...";
    canvas.width = 1280;
    canvas.height = 1280;
    ...
    videoDevices = devices.filter((d2) => d2.kind === "videoinput");
    if (videoDevices.length > 0) {
      ...
      if (savedDeviceId && videoDevices.find((d2) => d2.deviceId === savedDeviceId)) {
        cameraSelect.value = savedDeviceId;
      }
      status.textContent = "Ready! Select a camera";
      selectCameraBtn.disabled = false;
    } else {
...
selectCameraBtn.onclick = async () => {
  try {
    ...
    selectCameraBtn.disabled = true;
    cameraSelect.disabled = true;
    document.getElementById("stopBtn").disabled = false;
    document.getElementById("prevLensBtn").disabled = false;
    document.getElementById("nextLensBtn").disabled = false;
    if (lensConfig.length > 0) {
      await loadLens(0);
    }
  } catch (error) {
...
async function loadLens(index) {
  if (!lensConfig[index]) {
    status.textContent = "No lens at this index";
    return;
  }
  try {
    status.textContent = `Loading ${lensConfig[index].name}...`;
    if (currentLens) {
      await session.removeLens(currentLens);
    }
    const lens = await cameraKit.lensRepository.loadLens(lensConfig[index].id, GROUP_ID);
    await session.applyLens(lens);
    currentLens = lens;
    currentLensIndex = index;
    status.textContent = `${lensConfig[index].name} active`;
  } catch (error) {
    console.error("Lens error:", error);
    status.textContent = `Lens error: ${error.message}`;
  }
}
document.getElementById("prevLensBtn").onclick = async () => {
  const newIndex = (currentLensIndex - 1 + lensConfig.length) % lensConfig.length;
  await loadLens(newIndex);
};
document.getElementById("nextLensBtn").onclick = async () => {
  const newIndex = (currentLensIndex + 1) % lensConfig.length;
  await loadLens(newIndex);
};
document.getElementById("stopBtn").onclick = async () => {
  try {
    ...
    document.getElementById("prevLensBtn").disabled = true;
    document.getElementById("nextLensBtn").disabled = true;
  } catch (error) {
...
function renderLensList() {
  lensListDiv.innerHTML = "";
  lensConfig.forEach((lens, index) => {
    const lensItem = document.createElement("div");
    lensItem.className = "lens-item";
    lensItem.innerHTML = `
            <input type="text" value="${lens.name}" data-index="${index}" data-field="name" class="lens-name-input">
            <input type="text" value="${lens.id}" data-index="${index}" data-field="id" class="lens-id-input">
            <button class="delete-lens-btn" data-index="${index}">Delete</button>
        `;
    lensListDiv.appendChild(lensItem);
  });
  document.querySelectorAll(".lens-name-input, .lens-id-input").forEach((input) => {
    input.addEventListener("change", (e2) => {
      const index = parseInt(e2.target.dataset.index);
      const field = e2.target.dataset.field;
      lensConfig[index][field] = e2.target.value;
    });
  });
  document.querySelectorAll(".delete-lens-btn").forEach((btn) => {
    btn.addEventListener("click", (e2) => {
      const index = parseInt(e2.target.dataset.index);
      lensConfig.splice(index, 1);
      renderLensList();
    });
  });
}
addLensBtn.onclick = () => {
  lensConfig.push({ id: "", name: "New Lens" });
  renderLensList();
};
saveSettings.onclick = () => {
  localStorage.setItem("lensConfig", JSON.stringify(lensConfig));
  settingsModal.style.display = "none";
